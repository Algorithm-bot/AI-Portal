    ...
    <View style={{ flex: 1, backgroundColor: "#000" }}>
      {showWebView ? (
        ...
        <View style={styles.container}>
          ...
          {/* Description */}
          <Text style={styles.title}>ChatGPT: The AI That Talks Back</Text>
          <Text style={styles.description}>
            Imagine an AI that can chat, create, and solve problems like a
            digital Swiss Army knife. OpenAI's ChatGPT burst onto the scene,
            transforming how we work, learn, and communicate. From writing
            essays to coding solutions, this intelligent chatbot is rewriting
            the rules of human-machine interaction, one conversation at a time.
          </Text>
