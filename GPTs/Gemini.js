      ...
      {showWebView ? (
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.description}>
            Developed by Google, Gemini is an advanced AI that blends
            cutting-edge language understanding with powerful multimodal
            capabilities. It's not just another chatbot – it's a digital brain
            that can analyze text, images, code, and complex information,
            promising to revolutionize how we interact with technology and solve
